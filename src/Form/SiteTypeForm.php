...
use Drupal\multisite_manager\Entity\SiteType;

/**
 * Form handler for site type forms.
 */
final class SiteTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state): array {
    ...
    if ($this->operation === 'edit') {
      $form['#title'] = $this->t('Edit %label site type', ['%label' => $this->entity->label()]);
    }
  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    $this->messenger()->addStatus(
      match($result) {
        SAVED_NEW => $this->t('The site type %label has been added.', $message_args),
        SAVED_UPDATED => $this->t('The site type %label has been updated.', $message_args),
      }
    );
